<svg height="{{ $height }}" width="{{ $width }}" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#clip0_901_2934)">
    <path d="M3 1.00049V12.0005H5H9L16 5.00049L23 12.0005H27H29V1.00049H3Z" fill="#FFC44D"/>
    <path d="M9.00033 12.0005H4.99933V31.0005H27.0003V12.0005H22.9993L15.9993 5.00049L9.00033 12.0005Z" fill="#FFE6EA"/>
